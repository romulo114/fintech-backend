...
class AuthBase:
    ...
    def create_confirm_token(self, user_id: str) -> str:
        ...
        return self.__create_token(
            {"id": user_id, "expired": int(expire_time.timestamp())}, f"{sec_key}_conf"
        )
    ...
    def create_reset_token(self, user_id: str) -> str:
        ...
        return self.__create_token(
            {"id": user_id, "expired": int(expire_time.timestamp())}, f"{sec_key}_reset"
        )
    ...
    def create_tokens(self, user_id: int, access: str) -> Dict:
        ...
        access_token = self.__create_token(
            {"id": user_id, "access": access, "expired": int(expire_time.timestamp())},
            sec_key,
        )
        ...
        refresh_token = self.__create_token(
            {"id": user_id, "expired": int(expire_time.timestamp())}, f"{sec_key}_ref"
        )
