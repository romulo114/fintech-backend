...
class AuthParser:
    ...
    def parse_email_confirm(self, req: Request) -> dict:
        if not self.email_confirm:
            ...
            self.email_confirm.add_argument(
                "confirm_token", required=True, type=str, location="json"
            )
